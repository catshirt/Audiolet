import { AudioletGroup, AudioletInput, AudioletOutput } from '.';
...
class AudioletNode {
   ...
   */
  constructor(audiolet, numberOfInputs, numberOfOutputs, generate) {
