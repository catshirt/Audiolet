 ...
 * Linked to input 0.
 */
class Envelope extends AudioletNode {
   ...
   */
  constructor(audiolet, gate, levels, times, releaseStage, onComplete) {
    super(audiolet, 1, 1);
   ...
   */
  calculateChangeTime(stage, time) {
    var stageTime = this.times[stage].getValue() *
                    this.audiolet.device.sampleRate;
