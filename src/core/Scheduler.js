 ...
 * - Audio
 */
class Scheduler extends PassThroughNode {
   ...
   * @return {Object} The event object.
   */
  play(patterns, durationPattern, callback) {
    var event = {};
   ...
   * @return {Object} The event object.
   */
  playAbsolute(beat, patterns, durationPattern, callback) {
    if (beat < this.beat ||
      beat == this.beat && this.time > this.lastBeatTime) {
      // Nah
      return null;
