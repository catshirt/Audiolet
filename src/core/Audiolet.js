import { AudioletDestination } from '.';
...
class Audiolet {
   ...
   */
  constructor(sampleRate, numberOfChannels, bufferSize) {
    this.output = new AudioletDestination(this, sampleRate, numberOfChannels,
                                          bufferSize);
  }

}

export default { Audiolet };
